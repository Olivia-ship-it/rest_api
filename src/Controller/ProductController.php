...
class ProductController extends AbstractController
{
    ...
    public function addProduct(Request $request): Response
    {
        ...
        if(!$token){
            return $this->json(['error' => 'You need to login to add a product!', 
        ], 401);
        }
    ...
    public function showProduct(int $id): Response
    {
        ...
        if(!$product){
            return $this->json(['error' => 'Could not find such a product', 
        ], 401);
        }
    ...
    public function editProduct(int $id, Request $request): Response
    {
        ...
        if(!$token){
            return $this->json(['error' => 'You need to login to modify a product!', 
        ], 401);
        }
        ...
        return $this->json([
            'success' => 'Updated provided information of product named '.$product->getName(),
        ], 200); 
    }
    ...
    public function deleteProduct(int $id, Request $request): Response
    {
        ...
        if(!$token){
            return $this->json(['error' => 'You need to login to delete a product!', 
        ], 401);
        }
    ...
    public function addProductToCart(Request $request, int $productId): Response
    {
        ...
        return $this->json([
            'success' => 'Added product to shopping cart! ',
        ], 201);
    ...
    public function removeProductFromCart(Request $request, int $productId): Response
    {
        ...
        return $this->json([
            'success' => 'Removed product from shopping cart ',
        ], 201);
    }
